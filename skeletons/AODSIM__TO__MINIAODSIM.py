...
# with command line options: step2 --filein file:AODSIM.root --fileout file:MINIAOD.root --step PAT --conditions 94X_mcRun2_asymptotic_v3 --era Run2_2016,run2_miniAOD_80XLegacy --mc --runUnscheduled --eventcontent MINIAODSIM --datatier MINIAODSIM --no_exec -n 12345
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:12345'),
